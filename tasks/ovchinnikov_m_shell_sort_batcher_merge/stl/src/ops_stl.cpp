#include "ovchinnikov_m_shell_sort_batcher_merge/stl/include/ops_stl.hpp"
...
OvchinnikovMShellSortBatcherMergeSTL::OvchinnikovMShellSortBatcherMergeSTL(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
}

void OvchinnikovMShellSortBatcherMergeSTL::ShellSort(std::vector<int> &data) {
...
std::vector<int> OvchinnikovMShellSortBatcherMergeSTL::BatcherOddEvenMerge(const std::vector<int> &left,
...
bool OvchinnikovMShellSortBatcherMergeSTL::ValidationImpl() {
  return true;
}

bool OvchinnikovMShellSortBatcherMergeSTL::PreProcessingImpl() {
  data_ = GetInput();
  return true;
}

bool OvchinnikovMShellSortBatcherMergeSTL::RunImpl() {
...
bool OvchinnikovMShellSortBatcherMergeSTL::PostProcessingImpl() {
