#include "ovchinnikov_m_shell_sort_batcher_merge/tbb/include/ops_tbb.hpp"
...
bool OvchinnikovMShellSortBatcherMergeTBB::ValidationImpl() {
  return true;
}

bool OvchinnikovMShellSortBatcherMergeTBB::PreProcessingImpl() {
  data_ = GetInput();
  return true;
}

bool OvchinnikovMShellSortBatcherMergeTBB::RunImpl() {
...
bool OvchinnikovMShellSortBatcherMergeTBB::PostProcessingImpl() {
