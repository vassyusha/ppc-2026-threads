...
class ConvexHullTBBFuncTest : public ppc::util::BaseRunFuncTests<InputType, OutputType, TestCase> {
 public:
...
const auto kTestTasksList = std::tuple_cat(
    ppc::util::AddFuncTask<ConvexHullTBB, InputType>(kTestCases, PPC_SETTINGS_paramonov_v_bin_img_conv_hul_tbb));

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kFuncTestName = ConvexHullTBBFuncTest::PrintFuncTestName<ConvexHullTBBFuncTest>;

INSTANTIATE_TEST_SUITE_P(ParamonovHullTBBTests, ConvexHullTBBFuncTest, kGtestValues, kFuncTestName);

TEST_P(ConvexHullTBBFuncTest, RunFunctionalTests) {
