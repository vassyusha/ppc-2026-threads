...
class ConvexHullTBBPerformanceTest : public ppc::util::BaseRunPerfTests<InputType, OutputType> {
...
TEST_P(ConvexHullTBBPerformanceTest, RunPerformanceTest) {
...
const auto kPerformanceTasks =
    ppc::util::MakeAllPerfTasks<InputType, ConvexHullTBB>(PPC_SETTINGS_paramonov_v_bin_img_conv_hul_tbb);

const auto kTestValues = ppc::util::TupleToGTestValues(kPerformanceTasks);

INSTANTIATE_TEST_SUITE_P(ParamonovPerfTBBTests, ConvexHullTBBPerformanceTest, kTestValues,
                         ConvexHullTBBPerformanceTest::CustomPerfTestName);
