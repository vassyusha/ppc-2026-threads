...
bool RychkovaGaussSTL::PreProcessingImpl() {
  return true;
}

bool RychkovaGaussSTL::RunImpl() {
...
bool RychkovaGaussSTL::PostProcessingImpl() {
  return true;
}
