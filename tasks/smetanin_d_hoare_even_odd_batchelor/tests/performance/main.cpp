...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, SmetaninDHoarSortOMP, SmetaninDHoarSortSEQ, SmetaninDHoarSortSTL,
                                SmetaninDHoarSortTBB>(PPC_SETTINGS_smetanin_d_hoare_even_odd_batchelor);
