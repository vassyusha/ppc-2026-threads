...
VasilievMShellSortBatcherMergeTBB::VasilievMShellSortBatcherMergeTBB(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput() = OutType{};
}

bool VasilievMShellSortBatcherMergeTBB::ValidationImpl() {
  return !GetInput().empty();
}

bool VasilievMShellSortBatcherMergeTBB::PreProcessingImpl() {
  GetOutput().clear();
  return true;
}

bool VasilievMShellSortBatcherMergeTBB::RunImpl() {
  auto &vec = GetInput();
...
bool VasilievMShellSortBatcherMergeTBB::PostProcessingImpl() {
  return true;
}

std::vector<size_t> VasilievMShellSortBatcherMergeTBB::ChunkBoundaries(size_t vec_size, int threads) {
...
void VasilievMShellSortBatcherMergeTBB::ShellSort(std::vector<ValType> &vec, std::vector<size_t> &bounds) {
  size_t chunk_count = bounds.size() - 1;
...
void VasilievMShellSortBatcherMergeTBB::CycleMerge(std::vector<ValType> &vec, std::vector<ValType> &buffer,
...
std::vector<ValType> VasilievMShellSortBatcherMergeTBB::BatcherMerge(std::vector<ValType> &l, std::vector<ValType> &r) {
...
void VasilievMShellSortBatcherMergeTBB::SplitEvenOdd(std::vector<ValType> &vec, std::vector<ValType> &even,
...
std::vector<ValType> VasilievMShellSortBatcherMergeTBB::Merge(std::vector<ValType> &a, std::vector<ValType> &b) {
